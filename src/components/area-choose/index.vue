    ...
    props: {
      ...
      iconDirection: {
        ...
        default: function () { // 箭头图标
          return {
            left: 'appstore-iconfont appstore-iconpreviewleft',
            right: 'appstore-iconfont appstore-iconpreviewright'
          }
        }
      },
      chinaArea: {
    ...
    methods: {
        ...
        if (item) {
          ...
          if (this.leftData.length === this.districList.length) {
            ...
            this.leftData.push({
              ...
              regionId: this.selectItem.city.regionId 
            })
          }
        }
      ...
      cityNotLitmit (item) {  // 城市不限
        ...
        this.leftData.push({
          ...
          regionId: this.selectItem.province.regionId
        })
      },
