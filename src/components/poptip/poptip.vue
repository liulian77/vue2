...
<script>
    import Popper from '_c/base/popper';
    import iButton from '_c/button';
    ...
    export default {
        ...
        computed: {
            classes () {
                return [
                    `${prefixCls}`,
                    {
                        ...
                        [`${prefixCls}-arrow-none`]: !this.arrow,
                    }
                ];
            },
            popperClasses () {
            ...
            styles () {
                ...
                if(this.contentOffsetX){
                    style.transform=`translateX(${this.contentOffsetX}px)`
                }
                if(this.contentOffsetY){
                    style.transform=`translateY(${this.contentOffsetY}px)`
                }
                if(this.contentOffsetY&&this.contentOffsetX){
                    style.transform=`translate(${this.contentOffsetX}px,${this.contentOffsetY}px)`
                }
...
<style scoped>
    ...
    .ivu-poptip-arrow-none .ivu-poptip-arrow{
        display: none;
    }
    .ivu-poptip-body {
        padding: 8px 0;
