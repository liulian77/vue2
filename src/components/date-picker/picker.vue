...
<style scoped lang="less">
    ...
    /deep/ .ivu-picker-panel-body{
        ...
        .ivu-picker-panel-content-left, .ivu-picker-panel-content-right{
        ...
        .ivu-date-picker-cells-cell-start{
            em{
                position: static;
            }
            em:before{
        ...
        .ivu-date-picker-cells-cell-end{
            em{
                position: static;
            }
            em:before{
        ...
        .ivu-date-picker-cells-cell-range:nth-child(7n+1):before{
            border-radius: 0px 13px 13px 0px;
        }
        .ivu-date-picker-cells-cell-range:nth-child(7n+2){
            &:before{
